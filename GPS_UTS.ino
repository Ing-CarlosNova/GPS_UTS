...
void setup() {
  ...
  */
  ...
  modem.setNetworkSettings(F("internet.comcel.com.co"), F("comcel"), F("comcel"));
  ...
  modem.setNetworkSettings(F("Comcel")); // For Hologram SIM card
...
void moduleSetup() {
 ...
 /* modemSS.begin(115200); // Default SIM7000 shield baud rate
  ...
  if (! modem.begin(*modemSerial)) { //*modemSerial
